...
st.radio('What is your favorite album?',['reputation','1989 (Taylors version)','folklore','Red (Taylors version)','Fearless (Taylors version)','Speak Now (Taylors version)','evermore','Midnights'])
